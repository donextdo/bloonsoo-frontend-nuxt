        ...
        <form class="relative w-full h-full border-2 rounded-lg px-8 py-4 bg-white border-blue-500 flex flex-col gap-4 md:px-24" action="">
          ...
          <!-- CHECK IN DATE -->
            ...
            <div class="flex flex-col gap-2 items-start w-full relative">
                ...
                class="w-full md:w-1/3 p-4 flex flex-col gap-4 absolute -top-24 left-0 right-0 z-10 bg-white shadow-md mx-auto transition-all overflow-hidden border border-slate-400 rounded-md origin-center">
